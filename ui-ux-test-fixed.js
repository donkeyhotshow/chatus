...
class ChatAppUITester {
    ...
    async testHomePage() {
        ...
        try {
            ...
            const elements = await this.page.evaluate(() => {
                ...
                results.titleText = title ? title.textContent : '';
                ...
                results.elementsVisible = {
                    title: title ? (title.offsetWidth > 0 && title.offsetHeight > 0) : false,
                    usernameInput: usernameInput ? (usernameInput.offsetWidth > 0 && usernameInput.offsetHeight > 0) : false,
                    roomCodeInput: roomCodeInput ? (roomCodeInput.offsetWidth > 0 && roomCodeInput.offsetHeight > 0) : false,
                    submitButton: submitButton ? (submitButton.offsetWidth > 0 && submitButton.offsetHeight > 0) : false
                };
    ...
    async testPerformance() {
        ...
        this.addTestResult('performance',
            ...
            { metrics: performanceMetrics, issues: performanceIssues }
        );
    }
    ...
    async testInteractivity() {
        ...
        try {
            ...
            this.addTestResult('interactivity',
                ...
                { buttonEnabled, issues: interactivityIssues }
            );
