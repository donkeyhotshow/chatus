            ...
            >
                ...
                <div className="flex-shrink-0 p-4 border-b border-white/10">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <button
                            onClick={onClose}
                            className="p-3 hover:bg-white/10 rounded-lg transition-colors touch-target focus-visible-enhanced"
                        >
                        ...
                        <div className="p-4 space-y-2">
                            ...
                            {searchResults.map((result, index) => (
                                <motion.button
                                    ...
                                    className={cn(
                                        "w-full text-left p-3 rounded-lg transition-colors touch-target focus-visible-enhanced",
                                        selectedIndex === index
