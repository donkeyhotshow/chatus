...
export function NewMessageNotification({
    ...
    return (
        <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 z-30 animate-in slide-in-from-bottom-2">
            <Button
                onClick={handleClick}
                className="bg-cyan-500 hover:bg-cyan-600 text-white shadow-lg border border-cyan-400/50 rounded-full px-4 py-2 flex items-center gap-2 text-sm font-medium backdrop-blur-sm"
            >
